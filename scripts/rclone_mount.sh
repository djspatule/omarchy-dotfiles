...
#trying new vfs "full" mode....as well as skip drive shortcuts (i can alsways make shortcuts directly into nautilus)
rclone --drive-skip-shortcuts --vfs-cache-mode full mount Google\ Drive\ Perso: ~/Google\ Drive\ Perso &
